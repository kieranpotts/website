...
<!--
  Browser-facing stylesheet for the Atom feed. When a person opens
  /feeds/atom.xml in a browser, the <?xml-stylesheet?> instruction in the feed
          ...
          <article class="DOCUMENT">
            <div class="AsciiDoc">
              ...
              <p>This is the Atom feed for <a>
                ...
                my website</a>. There are also <a href="/feeds/rss.xml">RSS</a> and
